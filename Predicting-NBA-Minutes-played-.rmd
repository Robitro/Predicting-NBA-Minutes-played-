...
Rebounds: When the ball comes off of the backboard after a shot attempt and a player catches it he is awarded a rebound. These can be Offensive(`oreb`) or defensive(`dreb`).
...
# Results(Traditional Statistics)
